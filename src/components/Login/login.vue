        ...
        <el-card class="login-card">
            ...
            <el-form class="login" status-icon :model="loginForm" ref="loginForm">
                <el-form-item prop="username"
                    ...
                    <el-input placeholder="请输入用户名" v-model="loginForm.username" @keyup.enter.native="submitForm('loginForm')" @keyup.space.native="noSpace" type="text"></el-input>
                </el-form-item>
                <el-form-item prop="password"
                    :rules="[
                        {required: true, message: '密码不能为空', trigger: 'blur'}
                    ]">
                    <el-input placeholder="请输入密码" v-model="loginForm.password" @keyup.enter.native="submitForm('loginForm')" @keyup.space.native="noSpace" type="password"></el-input>
                </el-form-item>
                <el-form-item>
